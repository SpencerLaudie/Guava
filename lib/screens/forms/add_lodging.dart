...
class AddLodging extends StatelessWidget {
  const AddLodging(this.trip);
  final Trip trip;
...
class AddLodgingForm extends StatefulWidget {
  AddLodgingForm({Key? key, required this.trip}) : super(key: key);
  ...
  @override
  State<AddLodgingForm> createState() => _AddLodgingFormState();
}

class _AddLodgingFormState extends State<AddLodgingForm> {
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                  ...
                  onPressed: () {
                    trips[trips.indexWhere((t) => t.id == widget.trip.id)].addLodging(Lodging(
                      title: widget.title,
